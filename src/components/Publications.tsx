      ...
      <div className="max-w-5xl mx-auto space-y-16">
        <div className="space-y-4 text-center">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Peer-reviewed work that reflects my commitment to rigorous, systematic research.
          </p>
        </div>

        <div className="max-w-3xl mx-auto">
          <div className="relative rounded-2xl border border-border bg-card/80 backdrop-blur-sm overflow-hidden">
            {/* Academic-style top accent bar */}
            ...
            <div className="p-8 sm:p-10 space-y-6">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed pl-0 sm:pl-16">
                Collaborative research project focused on a Keke Payment System. This work was peer-reviewed and published with a DOI, demonstrating my ability to conduct systematic research and technical documentation.
              </p>
              ...
              <div className="flex flex-wrap gap-3 pl-0 sm:pl-16">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-border text-foreground text-sm font-medium hover:bg-accent hover:text-accent-foreground transition-colors"
                >
